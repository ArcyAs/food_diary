...
namespace FoodDiary.Repositories.Implementations
{
    public class ProductsRepository : IProductsRepository
    {
        ...
        {
            productEntity.Kcal =
                KcalCalculatorService.KcalCalculator(productEntity.Carb, productEntity.Fat, productEntity.Protein);
        ...
        public async Task EditProductInDataBase(ProductEntity newProductEntity, Guid id)
        {
            ...
            oldProductEntity.Kcal = KcalCalculatorService.KcalCalculator(newProductEntity.Carb, newProductEntity.Fat,
                newProductEntity.Protein);
